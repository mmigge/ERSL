...
```{r load}
#library(satellite)
path <- "/home/b_kar02/UNI/ERSL/ERSL/Geostat2018/practice/data/1990/clipped"
path
...
training <- read_sf("data/1990/train90/train.shp")
```
...
```{r featurePlot}
boxplot(trainDat$clip1~trainDat$type,las=2)
```
...
```{r featurePlot2}
featurePlot(x = trainDat[, c("clip2","clip3","clip4", "clip5")], 
...
```{r vars}
predictors <- c("clip1","clip2","clip3","clip4","clip5","clip6",
                "clip7")
response <- "type"
```
